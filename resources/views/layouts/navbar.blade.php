    ...
    <div class="container-fluid px-0">
        <div class="d-flex justify-content-between w-100" id="navbarSupportedContent">
            <div class="d-flex align-items-center">
                <!-- Search form -->
                <form method="GET" action="{{ route('search') }}" class="navbar-search form-inline">
                    <div class="input-group input-group-merge search-bar">
                        ...
                        <input type="text" name="search" class="form-control" placeholder="Search" aria-label="Search" aria-describedby="topbar-addon">
                    </div>
                </form>
                <!-- / Search form -->
            </div>
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <a href="#" class="list-group-item list-group-item-action border-bottom">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <!-- Avatar -->
                                        <img src="{{ asset('dist/images/avatar.png') }}" class="avatar-md rounded">
                                    </div>
                ...
                <li class="nav-item dropdown ms-lg-3">
                    <a class="nav-link dropdown-toggle pt-1 px-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="media d-flex align-items-center">
                            <img class="avatar rounded-circle" src="{{ Auth::user()->avatar_full_url }}">
